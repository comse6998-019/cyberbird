...
from lec2_planning_and_validation_agent.graph import build_graph, opening_messages
from lec2_planning_and_validation_agent.state import initial_state
from lec2_planning_and_validation_agent.trace import TerminalStatus, Trace, read_events
from lec2_planning_and_validation_agent.trajectory import to_mermaid
...
class ReactiveAgent:
    ...
    def __init__(self, alert: dict, config: Config = CONFIG,
                 ...
                 version: str = "v23", keep_unless_accepted: bool = True,
                 diagram: str = "mermaid"):
        self.alert = alert
        self.config = config
