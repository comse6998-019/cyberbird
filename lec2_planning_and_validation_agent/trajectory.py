...
actually did, in order, with who decided each step.
    ...
    python -m lec2_planning_and_validation_agent.trajectory runs/v23-bc284c6b.jsonl
    python -m lec2_planning_and_validation_agent.trajectory runs/v23-bc284c6b.jsonl --format mermaid
...
from lec2_planning_and_validation_agent.trace import read_events
