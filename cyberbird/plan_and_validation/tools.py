...
`cyberbird.plan_and_validation.workspace.resolve` before touching disk. That call is not optional: it is
...
from cyberbird.plan_and_validation.config import CONFIG
from cyberbird.plan_and_validation.exceptions import ToolFault
from cyberbird.plan_and_validation.workspace import resolve
