...
`cyberbird.reactive.workspace.resolve` before touching disk. That call is not optional: it is
...
from cyberbird.reactive.exceptions import ToolFault
from cyberbird.reactive.workspace import resolve
